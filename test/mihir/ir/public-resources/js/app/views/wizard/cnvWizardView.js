        ...
        var WizardView = Backbone.View.extend({
            ...
            _next: function(e) {
                ...
                if(this.detailView.modelFragement) {
                	if(typeof(this.detailView._nextClick) === 'function'){
                		this.detailView._nextClick();
                	}
                	this.detailView.modelFragement.unset('id');
            ...
            _processSelectedSpecimens: function(){
            ...
            _moveToStep: function(name) {
                ...
                require([this._steps().current().getDetailsPage(), this._steps().current().getSidebarPage()],
                    function(DetailsView, SidebarView) {
                        ...
                        var currentState = self._steps().current().getName();
                        
                        if(currentState === 'CONFIRM'){
                        	self.$('#save-cnv').css('display','block');
                        }else{
                        	self.$('#save-cnv').css('display','none');
                        }
            ...
            _now: function(){
            	//dispatcher.trigger('now:saveAndEval', {});
            	//dispatcher.trigger('save:cnv', {});
            },
            
            _later: function(e){
            	dispatcher.trigger('save:cnv', e);
            }
