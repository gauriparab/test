/*global define:false*/
define(['jquery', 'underscore', 'backbone', 'collections/metagenomicReferences', 'events/eventDispatcher', 'hb!templates/workflow-reference-genome.html'], 
        function($, _, Backbone, ReferenceGenomesCollection, dispatcher, template) {
    "use strict";
    var ReferenceGenomeCollectionView = Backbone.View.extend({
        ...
        selectionChanged: function(e) {
            ...
            this.model.setMetagenomicRef(referenceGenomes.toJSON());
            dispatcher.trigger('change:metagenomicReference', referenceGenomes.toJSON());
        }
    });
