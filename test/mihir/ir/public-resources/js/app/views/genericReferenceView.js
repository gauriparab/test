/*global define:false*/
define(['jquery', 'underscore', 'backbone', 'collections/genericReferences', 'events/eventDispatcher', 'hb!templates/workflow-reference-genome.html'], 
    ...
    var ReferenceGenomeCollectionView = Backbone.View.extend({
        ...
        render: function() {
            ...
            this.selected = this.model && this.model.getGenericRef() || null;
        ...
        selectionChanged: function(e) {
            ...
            this.model.setGenericRef(referenceGenomes.toJSON());
            dispatcher.trigger('change:genericReference', referenceGenomes.toJSON());
        }
    });
